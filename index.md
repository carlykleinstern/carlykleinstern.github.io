...
<div>
    <p style="float: left;"><img src="photos/bean.jpg" height=300px width=auto border=200px align=right padding: 0 7em 2em 0 ></p> <p align=left>  My research is high-altitude in-situ water vapor and water vapor isotopologue measurements in the upper troposphere and lower stratosphere (UT/LS). </p>
</div>
...
>
  ...
  <br>
  <button style="height:60px;width:100px;color:#0f5f6b; font-weight:bold; border-color:#0f5f6b; background-color:WhiteSmoke"; type="submit">Send</button>
</form>
